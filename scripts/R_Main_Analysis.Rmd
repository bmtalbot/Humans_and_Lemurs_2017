...
# Version of Code
This code is maintained by Brooke M. Talbot. This is Version 2.0 updated last on 4/1/2024
...
#abundance_table <- read.table("Supplemental_Talbot_4_v2.csv", header = FALSE, comment.char = "$", sep =',', fill = TRUE)

table4 <- read.table("~/Supplemental_Talbot_4_v2.csv", header = FALSE, comment.char = "$", sep =',', fill = TRUE)
...
Figure1resub <- cowplot::plot_grid(nrow = 2, ncol = 1, top, bottom)

#ggsave("Fig1_new_resub_dpi_1200.pdf", Figure1resub, height = 8, width = 15, dpi = 1200)
...
Fig2A
Fig2C <- fig2C + theme(plot.margin = unit(c(0.1,1.4,0.1,1.4), "inches"))
Fig2B <- species_biplot #p_vill_spec_clr
Fig2D <- chao_rare_species_bact + theme(plot.margin = unit(c(0.1,0.5,0.1,0.5), "inches"))

Fig2 <- cowplot::plot_grid(Fig2A_bact,Fig2B_bact,Fig1C,Fig1D, nrow = 2, ncol = 2,rel_widths = c(0.9,0.75,0.9,0), rel_heights = c(0.75,0.5,0.9,0), labels = c("a","b","c","d"))
